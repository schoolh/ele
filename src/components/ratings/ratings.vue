    ...
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        ...
        <ul class="rating-list">
          <li v-show="needShow(rating.text, rating.rateType)" v-for="(rating, index) in ratings" class="rating-item" :key="index">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                ...
                <span v-if="rating.deliveryTime" class="delivery">{{rating.deliveryTime}}</span></div>
